...
`training_pipeline.ipynb` expects MuRIL text features and ResNet-50 image
features already extracted — it does not extract them from raw data. To
reproduce training/calibration without re-running feature extraction:

1. Download the features from <https://drive.google.com/drive/folders/1IhgqsSMk6xz2XcqQhqgEbSfU7oYa7dk6?usp=sharing>.
